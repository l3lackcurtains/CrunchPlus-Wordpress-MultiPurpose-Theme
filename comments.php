 ...
 * handled by a callback to cplus_comment() which is
...
<div id="comments" class="comments-area">
	...
	<?php
	     ...
	     * to use cplus_comment() to format the comments.
	     * If you want to overload this in a child theme then you can
	     * define cplus_comment() and that will be used instead.
	     * See cplus_comment() in includes/template-tags.php for more.
	     */
	    wp_list_comments( array( 'callback' => 'cplus_comment', 'avatar_size' => 50 ) );
	?>
	</ol><!-- .comment-list -->
